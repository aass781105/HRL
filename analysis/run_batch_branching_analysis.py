...
if "--config" in sys.argv:
    ...
    # Default to bottleneck config file
    config_path = os.path.join(project_root, "yaml_config", "eval_bottleneck.yml")
...
def main():
    ...
    out_dir = os.path.join(project_root, "analysis_results", "branching_compare", f"batch_{timestamp}")
