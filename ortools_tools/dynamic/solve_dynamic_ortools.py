    ...
    for job in jobs:
        ...
        for op in operations:
            ...
            all_tasks[(job_id, op_id)] = {
                ...
                "is_urgent": bool(job.get("is_urgent", False)),
                "due_date_k": float(job.get("due_date_k", 0.0)),
                "num_ops": num_ops,
        ...
        rows.append(
            {
                ...
                "Due_Date": due_date,
                "Is_Urgent": int(bool(task.get("is_urgent", False))),
                "Due_Date_K": float(task.get("due_date_k", 0.0)),
