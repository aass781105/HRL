...
from model.ll_dan_model import *
...
class LLPPO:
    def __init__(self, config):
        ...
        """
        self.lr = config.ll_lr
        self.gamma = config.ll_gamma
        self.gae_lambda = config.ll_gae_lambda
        self.eps_clip = config.ll_eps_clip
        self.k_epochs = config.ll_k_epochs
        self.tau = config.ll_tau

        self.ploss_coef = config.ll_ploss_coef
        self.vloss_coef = config.ll_vloss_coef
        self.entloss_coef = config.ll_entloss_coef
        self.minibatch_size = config.ll_minibatch_size
...
def ll_ppo_initialize():
    ppo = LLPPO(config=configs)
    return ppo
