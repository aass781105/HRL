        ...
        if filename.startswith("eval_baseline_seed") and filename.endswith(".yml"):
            ...
            for line in lines:
                ...
                if line.strip().startswith("hl_gate_policy:"):
                    updated_lines.append("hl_gate_policy: slack_threshold\n")
                # Check for hl_buffer_slack_release_threshold
                elif line.strip().startswith("hl_buffer_slack_release_threshold:"):
                    updated_lines.append("hl_buffer_slack_release_threshold: 0\n")
                else:
